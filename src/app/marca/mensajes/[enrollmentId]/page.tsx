...
export default async function MarcaMensajeThreadPage({
  params,
}: {
  ...
  return (
    <div>
      ...
      <h1 className="font-display text-2xl font-semibold text-brand-ink mb-6">{thread.enrollment.creator.displayName}</h1>
