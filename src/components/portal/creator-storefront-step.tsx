...
type EnrollmentItem = { id: string; brandName: string; logoUrl: string | null; visible: boolean };
  ...
  return (
    <form onSubmit={handleSubmit} className="max-w-2xl space-y-8">
      <div className="rounded-2xl border-2 border-brand-accent bg-brand-accent-soft p-5">
        <p className="text-sm font-medium text-brand-ink mb-1">Tu link — ponlo en tu bio de Instagram/TikTok o compártelo por WhatsApp/correo</p>
