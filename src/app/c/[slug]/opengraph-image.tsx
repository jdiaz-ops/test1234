  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        <div style={{ display: "flex", fontSize: 30, color: palette.accent, marginBottom: 10 }}>{displayName}</div>
        <div
          style={{
            display: "flex",
            fontSize: 52,
        ...
        <div style={{ display: "flex", position: "absolute", bottom: 44, fontSize: 24, color: palette.inkSoft }}>
