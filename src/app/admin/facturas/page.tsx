  ...
  return (
    <div>
      ...
      <p className="text-sm text-brand-ink-soft mb-8 max-w-lg">
        Sube el PDF de la factura electrónica ya generada por el proveedor de
        facturación — queda disponible de inmediato para que la marca la vea y
        descargue desde Cuenta → Facturación.
      </p>

      <AdminInvoiceUpload
        brands={brands.map((b) => ({ id: b.id, companyName: b.companyName }))}
      />
      ...
      {invoices.length === 0 ? (
        <p className="text-sm text-brand-ink-soft">
          Todavía no se ha subido ninguna factura.
        </p>
      ) : (
